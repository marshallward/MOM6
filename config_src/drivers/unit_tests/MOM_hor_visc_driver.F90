! This is a temporary program to run unit tests on MOM_hor_visc
! I would like it tobe integrated into MOM_unit_test_driver, but lets see how
! far I can get...
...
end program MOM_hor_visc_driver
