...
public calculate_density_derivs_elem_Jackett06_loc
public calculate_specvol_derivs_elem_Jackett06_loc
...
!> Standalone (GPU-callable) variant of calculate_density_derivs_elem_Jackett06.
elemental subroutine calculate_density_derivs_elem_Jackett06_loc(T, S, pressure, drho_dT, drho_dS)
  !$omp declare target
  real, intent(in)  :: T        !< Potential temperature relative to the surface [degC]
  real, intent(in)  :: S        !< Salinity [PSU]
  real, intent(in)  :: pressure !< Pressure [Pa]
...
end subroutine calculate_density_derivs_elem_Jackett06_loc
...
!> Standalone (GPU-callable) variant of calculate_specvol_derivs_elem_Jackett06.
elemental subroutine calculate_specvol_derivs_elem_Jackett06_loc(T, S, pressure, dSV_dT, dSV_dS)
  !$omp declare target
  real, intent(in)    :: T        !< Potential temperature [degC]
  real, intent(in)    :: S        !< Salinity [PSU]
  real, intent(in)    :: pressure !< Pressure [Pa]
...
end subroutine calculate_specvol_derivs_elem_Jackett06_loc
